              ...
              <div className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-5 py-5 text-lg text-gray-900 bg-transparent border-2 rounded-xl transition-all duration-300 focus:outline-none hover:border-blue-300 ${
                      errors.email 
